...
public class NonKitten extends Case {
	...
	/**
	 * Le constructeur des NonKittenItems
	 * Est construit a une position donnee en parametre
	 * Prend un symbole valide au hasard comme representation
	 * Prend un flavorText au hasard de descriptions
	 * 
	 * @param pos La position donnee au NonKitten
	 */
	public NonKitten (Point pos) {
		this.pos = pos;
	...
	/**
	 * Retourne un flavorText puise dans descriptions pour le constructeur
	 * 
	 * @return Un flavorText de la banque descriptions
	 */
	public String genererFlavorText() {
		int index = (int)Math.round(Math.floor(Math.random()*descriptions.length));
		
		return descriptions[index];
	}
	
	/**
	 * Retourne la position du NonKitten
	 * 
	 * @return La position du NonKitten
	 */
	public Point getPos() {
		return this.pos;
	}
	...
	/**
	 * Indique si l'interaction NonKitten-robot est possible
	 * Toujours vrai (on sait que le robot est a la bonne position
	 * d'apres la grille)
	 * 
	 * @param robot Le robot qui tente d'interagir avec le NonKitten
	 */
	...
	/**
	 * Imprime le flavorText du NonKitten avec lequel le robot interagit
	 * 
